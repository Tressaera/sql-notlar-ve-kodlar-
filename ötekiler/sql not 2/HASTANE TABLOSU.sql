create database hastane1;
use hastane1;
CREATE TABLE HASTALAR5
...
values('18','10','23'),('19','20','25');
  ...
  insert into hastalar5(hasta_no,adi,soyadi,dg_yeri,dg_tar) 
